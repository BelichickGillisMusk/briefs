...
const CommandCenterData = {
    ...
    tasks: [
        ...
        },
        {
            ...
            description: "Retest engine ran on Master CRM (demo data — swap in real export to refresh). Buckets: 🔴 4 URGENT, 🟠 4 HOT, 🟡 4 WARM, 🟢 2 EARLY. Call URGENT/HOT this week, email WARM/EARLY. Report: docs/retest-retention-2026-06.md • Spec: briefs/retest-retention-check.json",
            agent: "client-agent",
            agentName: "Client Relations",
            status: "active",
            priority: "high",
    ...
    mail: [
        ...
        },
        {
            ...
            subject: "🔄 Monthly Retest Check (June 2026): 4 URGENT, 4 HOT — call this week",
            preview: "Engine ran against Master CRM. 14 of 20 customers are actionable this cycle. 🔴 URGENT (≤7d): 4 overdue/due-now. 🟠 HOT (8–30d): 4. 🟡 WARM (31–60d): 4. 🟢 EARLY (61–90d): 2. See docs/retest-retention-2026-06.md for the prioritized call list and email blast copy.",
            time: "Just now",
            unread: true,
            priority: "high",
            category: "action-required"
    ...
    activities: [
        ...
        },
        {
            ...
            type: "agent",
            icon: "target",
            text: "<strong>Retest Retention Engine</strong> ran monthly check — 4 URGENT, 4 HOT, 4 WARM, 2 EARLY (June 2026)",
            time: "Just now"
        },
        {
            id: "act-000",
    ...
    // Generated by leads/retest_retention_check.py from leads/retest-customers-sample.csv.
    // ⚠️ Sample data — swap in real Master CRM export and re-run before calling.
    retestRetention: {
        name: "Monthly Retest Retention Check",
        asOf: "2026-06-23",
        cadence: "Monthly on the 23rd",
        triggerPhrase: "Run monthly retest check",
        source: "leads/retest-customers-sample.csv",
        ...
        buckets: [
            { id: "urgent", label: "🔴 URGENT", window: "≤ 7 days", action: "Call immediately", count: 4 },
            { id: "hot", label: "🟠 HOT", window: "8–30 days", action: "Call this week", count: 4 },
            { id: "warm", label: "🟡 WARM", window: "31–60 days", action: "Email + follow-up call", count: 4 },
            { id: "early", label: "🟢 EARLY", window: "61–90 days", action: "Email reminder only", count: 2 },
            { id: "out_of_window", label: "⚪ OUT", window: "> 90 days", action: "Re-check next month", count: 6 }
        ]
    },
